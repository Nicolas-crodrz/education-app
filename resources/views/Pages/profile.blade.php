        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    ...
                    <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}+{{ Auth::user()->lastname }}"
                        alt="Avatar" class="avatar img-thumbnail rounded-circle" width="100px" height="100px">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right texto">Profile Settings</h4>
                    </div>
                    <div class="row mt-2">
                        {{-- NAME --}}
                        <div class="col-md-6">
